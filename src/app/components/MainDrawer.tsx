...
export function MainDrawer(props: {
  drawerState: boolean;
  toggleDrawerState: React.Dispatch<React.SetStateAction<boolean>>;
}) {
  return (
    <Drawer
      sx={{
    ...
    >
      ...
      >
        <IconButton
          ...
          onClick={() => props.toggleDrawerState(false)}
        >
          <ChevronLeft style={{ width: "24px" }} />
        </IconButton>
        {drawerItems.map((drawerItem) => (
          <ListItem key={drawerItem.key} disablePadding>
            <Link href={drawerItem.link} color="inherit" underline="hover">
